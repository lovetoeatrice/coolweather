...
public class CoolWeatherDB {
	...
	private CoolWeatherDB(Context context){//讲构造方法私有化
	...
	public List<Province>loadProvinces(){//从数据库读取某全国所有的省份信息
	...
	public List<County>loadCounties(int cityId){//从数据库读取城市下所有县的信息
